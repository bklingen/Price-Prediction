...
As expected, these two columns are quite correlated.
We are dropping not dropping any feature by now but will be useful for future  explanations.
...
As expected, these two columns are quite correlated. 
We are not dropping any features by now, but will be useful for future explanations.
