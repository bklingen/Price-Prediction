...
bAIC.prediction<-predict(lm.bAIC, interval = "prediction", trace = 0)
fAIC.prediction<-predict(lm.fAIC,interval="prediction", trace = 0)
dAIC.prediction<-predict(lm.dAIC,interval="prediction", trace = 0)
```
